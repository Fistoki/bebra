...
for (let i = 0; i < numItems; i++) {
  let items = tellimus.rows[i];
  let productName = items.name; 
  let quantity = items.amount;
  ...
  console.log("Price: (without vat) " + price.toFixed(2));
  console.log("Summ:(with vat) " + total.toFixed(2));
  console.log("\n"); 
...
console.log("Summary summ : " + totalAmount.toFixed(2));